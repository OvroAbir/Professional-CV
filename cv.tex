...
\usepackage{fullpage}
\usepackage{geometry}
\geometry{left=0.2in,right=0.2in,top=0.2in,bottom=0.1in} %margin
...
\titlespacing{\section}{0pt}{-0.15cm}{0cm}
...
\begin{itemize}
    ...
    Area - \textbf{Software Engineering}. My advisor is \href{https://www.cs.colostate.edu/~lmorenoc}{Dr. Laura Moreno}. Working on automatically detecting Domain Data Constraints in Software Documentation artifacts. Currently constructing patterns of constraint descriptions to feed into \textbf{NLP} model. 
...
\begin{itemize}
    ...
    \item \textsc{Distributed Fact checking System for News articles} - 
    %\begin{itemize}
        %\item 
        Developing a distributed system to find similar news articles from over \textbf{9,410K} articles with a goal of  comparing facts of a news from different sources.
        Using \textbf{Apache Spark}, \textbf{MLlib}.
    %\end{itemize}
...
\begin{tabular}{p{8.35cm}|p{7cm}}
        ...
        Dhaka, Bangladesh \newline
y        Email : \href{mailto:nur.yanhaona@konasl.com}{nur.yanhaona@konasl.com} \newline
